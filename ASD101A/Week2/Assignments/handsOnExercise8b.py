...
PERCENT_TIP = float (input("Enter the tip percentage: "))     # Will enter tip amount in decimal(in this scenario, it is 18%)
SALES_TAX = .07                                                   # Sales tax is a constant, until changed

#Check user input and determine if percentage or decimal was entered
...
print(f'Bill Amount = ${BILL_AMOUNT:,.2f}\n'
      f'Percent Sales Tax = {SALES_TAX:.0%}\n'
      f'Total Tax = ${TAX_TOTAL:,.2f}\n'
      f'Percent Tip Amount = {PERCENT_TIP:.0%}\n'
      f'Total Tip Amount = ${TIP_TOTAL:,.2f}')
